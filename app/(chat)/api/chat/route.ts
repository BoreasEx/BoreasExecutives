...
function isConversationEnded(message: string): boolean {
  ...
  return (
    ...
    text.includes("we can move forward under the following conditions") ||
    text.includes("we can move forward under conditions") ||
    text.includes("we are prepared to move to the next stage under the following conditions")
  );
}
